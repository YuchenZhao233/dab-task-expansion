import re
EXPECTED_STRINGS = ["electronics"]
EXPECTED_NUMBERS = [0.68]
def contains_number(text, expected, tolerance=0.01):
...
def validate(llm_output):
    ...
    return True, "Found expected category and freight-to-price ratio."
